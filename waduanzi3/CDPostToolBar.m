...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _likeButton.titleLabel.font = _commentButton.titleLabel.font = _actionButton.titleLabel.font = [UIFont systemFontOfSize:12.0f];
        _likeButton.titleEdgeInsets = _commentButton.titleEdgeInsets = _actionButton.titleEdgeInsets = UIEdgeInsetsMake(0, 10.0f, 0, 0);
    }
    return self;
}
