...
- (void)setupTableView
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain appkey:UMAPPNETWORK_APPKEY slotId:nil currentViewController:self];
